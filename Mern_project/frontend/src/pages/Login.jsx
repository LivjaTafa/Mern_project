...
const LoginPage = () => {
	...
	const handleSubmit = (e) => {
		e.preventDefault();
		login(email, password); // Thirrni funksionin për t'u regjistruar
	};
	...
	return (
		<div className='flex flex-col justify-center py-12 sm:px-6 lg:px-8'>
			...
			>
				<h2 className='mt-6 text-center text-3xl font-extrabold text-emerald-400'>Login to Your Account</h2> {/* Ndryshimi i titullit */}
			</motion.div>
